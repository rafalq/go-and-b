...
// InsertReservation inserts a reservation inot the database
...
// SearchAvailabilityByDatesByRoomID returns true if availability exsits for a specific roomID, and false if no availability exists
...
func (m *postgresDBRepo) Authenticate(email, testPassword string) (int, string, error) {
	...
	if err == bcrypt.ErrMismatchedHashAndPassword {
		return 0, "", errors.New("inncorect password")
	} else if err != nil {
		return 0, "", err
	}
